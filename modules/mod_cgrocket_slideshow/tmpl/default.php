<?php 
/*---------------------------------------------------------------
# Package - Module SlideShow by CGrocket.com 
# ---------------------------------------------------------------
...
$doc->addStyleSheet ( 'modules/mod_cgrocket_slideshow/css/cgrocket.css' );
if($show_jquery=="yes" && $load=="onload" && $jver=="1.5.2")

{

$doc->addScript("modules/mod_cgrocket_slideshow/js/jquery-1.5.2.min.js");
...
.box_cgrocket {margin-bottom:40px;}
...
ass".$module->id."('.box_cgrocket_large".$module->id."').cgrocket(
{
dots: ".$dots.",
fullscreen: false,
label: true,
...
<style type="text/css" >
.box_cgrocket_large<?php echo $module->id;?> {width:<?php echo $slidewidth;?>px;height:<?php echo $slideheight; ?>px;}
<?php echo $margin;?>
.box_cgrocket_small {width:200px;height:200px;}
.box_cgrocket {border:<?php echo $border;?>px solid <?php echo $bordercolor;?>; background:<?php echo $backgroundcolor;?>}
.label_cgrocket h5
{
padding-left: 10px !important;

}
.label_cgrocket h5,.label_cgrocket h5 a{
margin:0;
...
?>
.box_cgrocket .info_slide {position:absolute;top:100%; margin-top:15px; }
.box_cgrocket {margin-bottom:40px;}
<?php } ?>
<?php if($numbers!="" && $numberspos=="top")
{
?>
.box_cgrocket .info_slide {position:absolute;top:-45px; }
.box_cgrocket {margin-top:30px;}
<?php } ?>
<?php if($arrows=="true" && $arrowspos=="bottom")
{
?>
.prev_button {top:100%; margin-top:10px;margin-bottom:25px;}
.box_cgrocket .next_button {top:100%;margin-top:10px;margin-bottom:25px;}
.box_cgrocket {margin-bottom:50px;}
<?php } ?>
...
.box_cgrocket .next_button {top:-25px; }
.box_cgrocket {margin-top:50px;}
...
if($jver=="1.5.2")
{
$j0=JUri::root()."modules/mod_cgrocket_slideshow/js/jquery-1.5.2.min.js";
}
else
{
$j0="http://ajax.googleapis.com/ajax/libs/jquery/".$jver."/jquery.min.js";
}
$j1=JUri::root()."modules/mod_cgrocket_slideshow/js/jquery.easing.1.3.js";
$j2=JUri::root()."modules/mod_cgrocket_slideshow/js/jquery.animate-colors-min.js";
$j3=JUri::root()."modules/mod_cgrocket_slideshow/js/jquery.cgrocket.min.js";
...
<div class="box_cgrocket box_cgrocket_large<?php echo $module->id;?>" >
<ul>
...
<p class="dnn">By CGrocket.com <a href="http://www.cgrocket.com/" title="WebSite Design">Web Design</a></p>